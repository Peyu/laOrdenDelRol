...
Evento.create!([
  ...
  {imagen: "Mendotaku_-_La_conspiracion.jpg", titulo: "Unicomix en Leparc", cuerpo: "En el marco del evento Unicomix, en el Leparc, fuimos convocados para una de nuestras charlas. El público quedó encantado y lamentamos no poder tener mesas de juego en esta oportunidad."},
  ...
  {imagen: "Literarol.jpg", titulo: "Literarol 2da Edicion - 2013", cuerpo: "Nuevamente fuimos convocados en la biblioteca de Chacras para continuar con el evento Literol. Esta vez con más participantes y más actividades."}
])
Usuario.create!([
