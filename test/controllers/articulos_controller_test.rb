...
class ArticulosControllerTest < ActionController::TestCase
  ...
  test "should create articulo" do
    assert_difference('Articulo.count') do
      post :create, articulo: { cuerpo: @articulo.cuerpo, subtitulo: @articulo.subtitulo, titulo: @articulo.titulo }
    end
  ...
  test "should update articulo" do
    patch :update, id: @articulo, articulo: { cuerpo: @articulo.cuerpo, subtitulo: @articulo.subtitulo, titulo: @articulo.titulo }
    assert_redirected_to articulo_path(assigns(:articulo))
  end
